<?php
class model_forfait extends abstract_model{
	
	protected $sClassRow='row_forfait';
	
	protected $sTable='forfait';
	protected $sConfig='pdoMysqlExple';
	
	protected $tId=array('id_forfait');
	...
	public function findById($uId){
		return $this->findOne('SELECT * FROM '.$this->sTable.' WHERE id_forfait=?',$uId );
	}
...
class row_forfait extends abstract_row{
	
	protected $sClassModel='model_forfait';
