<?php
class model_QuestionSecrete extends abstract_model{
	
	protected $sClassRow='row_QuestionSecrete';
	
	protected $sTable='QuestionSecrete';
	...
	public function getSelect(){
		...
		if($tab){
		foreach($tab as $oRow){
			$tSelect[ $oRow->id_question ]=$oRow->question;
		}
		}
		return $tSelect;
	}
...
class row_QuestionSecrete extends abstract_row{
	
	protected $sClassModel='model_QuestionSecrete';
