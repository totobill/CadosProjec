<?php
class model_pays extends abstract_model{
	
	protected $sClassRow='row_pays';
	
	protected $sTable='pays';
	protected $sConfig='pdoMysqlExple';
	
	protected $tId=array('id_pays');
	...
	public function findById($uId){
		return $this->findOne('SELECT * FROM '.$this->sTable.' WHERE id_pays=?',$uId );
	}
...
class row_pays extends abstract_row{
	
	protected $sClassModel='model_pays';
