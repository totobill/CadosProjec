<?php
class model_ville extends abstract_model{
	
	protected $sClassRow='row_ville';
	
	protected $sTable='ville';
	protected $sConfig='pdoMysqlExple';
	
	protected $tId=array('id_ville');
	...
	public function findById($uId){
		return $this->findOne('SELECT * FROM '.$this->sTable.' WHERE id_ville=?',$uId );
	}
	...
	public function getSelect(){
		...
		if($tab){
		foreach($tab as $oRow){
			$tSelect[ $oRow->id_ville ]=$oRow->nom;
		}
		}
		return $tSelect;
	}
